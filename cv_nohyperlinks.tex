...
\begin{center}
    ...
    \vspace{5pt}
    Kochi, India $\cdot$ aaromalonline@gmail.com $\cdot$ \href{https://aaromalonline.codeberg.page}{aaromalonline.codeberg.page} \\
    \vspace{4pt}
...
\vspace*{2mm}
\header{Education}
\textbf{Central Board of Secondary Education (CBSE)} \hfill Kerala, 2022 -- 2024\\
...
\textbf{Cochin University of Science \& Technology (CUSAT)} \hfill Kerala, 2024 -- 2028\\
...
\textbf{Ecometachip Mini: Low-Cost Eco-Friendly Dielectric Chemical Identifier} \hfill New Delhi\\
\textit{Lecture Presentation, IEEE APSCON 2026 (Student Research Forum)} \hfill Jan 2026\\
...
\textbf{Liberate:ATCS - Adaptive Typing \& Control System} \hfill \textit{Feb 2025 - Sep 2025}\\
...
\textbf{CardioKey (ECGID) - Analog ECG Acquisition \& Biometrics} \hfill \textit{Mini-project, Feb 2026 - Present}\\
...
\textbf{PassCrypt - Password Manager} \hfill {\sl Python, SQLite3} \\
\begin{itemize}
...
\textbf{Truevote: Digital Voting System} \hfill {\sl C++, Qt, SHA256 Hashing, CMake} \\
...
\textit{Horizon Mars Rover Team, CUSAT} \hfill \textit{Kochi, India}
\begin{itemize}
...
\textit{FOSS CUSAT | Community} \hfill \textit{Kochi, India}
\begin{itemize}
...
\begin{itemize} \itemsep 1pt
    ...
    \item \textbf{Certifications:} \textbf{MathWorks:} Data Analysis, Modeling, Simulink, and MATLAB Onramp.
\end{itemize}
